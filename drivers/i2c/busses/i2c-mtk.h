...
struct i2c_regs_info {
	unsigned int OFFSET_SLAVE_ADDR;
	unsigned int OFFSET_INTR_MASK;
	unsigned int OFFSET_INTR_STAT;
	unsigned int OFFSET_CONTROL;
	unsigned int OFFSET_TRANSFER_LEN;
	unsigned int OFFSET_TRANSAC_LEN;
	unsigned int OFFSET_DELAY_LEN;
	unsigned int OFFSET_TIMING;
	unsigned int OFFSET_START;
	unsigned int OFFSET_FIFO_STAT;
	unsigned int OFFSET_IO_CONFIG;
	unsigned int OFFSET_HS;
	unsigned int OFFSET_DCM_EN;
	unsigned int OFFSET_DEBUGSTAT;
	unsigned int OFFSET_EXT_CONF;
	unsigned int OFFSET_TRANSFER_LEN_AUX;
};
