			     ...
			     unsigned int flags, bool grab_handle)
{
	...
	if (WARN_ONCE(len + ion_total_memory > ion_max_total_memory,
			"ion alloc failed, ion total memory had exceed 1G !!! %zu %16zu %lu",
			len, ion_total_memory, ion_max_total_memory)) {
