...
int mt_led_blink_pmic(enum mt65xx_led_pmic pmic_type, struct nled_setting *led)
{
	...
	case MT65XX_LED_PMIC_NLED_ISINK0:
		...
		{
		    pmic_set_register_value(PMIC_ISINK_CH0_STEP, ISINK_2);	/* 16mA */
		}
                else
                {
                    pmic_set_register_value(PMIC_ISINK_CH0_STEP, ISINK_0);
                }
	...
	case MT65XX_LED_PMIC_NLED_ISINK1:
		...
		pmic_set_register_value(PMIC_ISINK_CH1_STEP, ISINK_0);	/* 16mA */
	...
	case MT65XX_LED_PMIC_NLED_ISINK2:
		...
		pmic_set_register_value(PMIC_ISINK_CH4_STEP, ISINK_0);	/* 16mA */
	...
	case MT65XX_LED_PMIC_NLED_ISINK3:
		...
		pmic_set_register_value(PMIC_ISINK_CH5_STEP, ISINK_0);	/* 16mA */
...
int mt_brightness_set_pmic_combo(enum mt65xx_led_pmic pmic_type, u32 level, u32 div)
{
	static bool first_time = true;
