...
kal_bool chargin_hw_init_done_rt = false; /* Used by MTK battery driver */
...
static int rt9466_parse_dt(struct rt9466_info *info, struct device *dev)
{
	...
	int irqnum = 0;
	printk("rt9466_parse_dt\n");

	np = of_find_compatible_node(NULL, NULL,"richtek,rt9466");
	...
	const struct i2c_device_id *dev_id)
{
	...
	chargin_hw_init_done_rt = KAL_TRUE;
	return ret;
