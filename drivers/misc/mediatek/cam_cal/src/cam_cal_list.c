...
unsigned int mtkCidList[MTK_MAX_CID_NUM] = {
	0x00000001,/*Single MTK Format*/
	0x0000000c,/*Double MTK Format in One OTP/EEPRom - Legacy*/
	0x00000006, /*qt imx298*/
};
...
stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	...
	{S5K3L8_SENSOR_ID, 0xA0, CMD_GT24C32A, cam_cal_check_mtk_cid},
	{S5K3L8_SENSOR_ID_SUNRISE, 0xA0, CMD_GT24C32A, cam_cal_check_mtk_cid},
	{IMX298_SENSOR_ID, 0xA0, CMD_GT24C32A, cam_cal_check_mtk_cid},
	{IMX299_SENSOR_ID, 0xA0, CMD_GT24C32A, cam_cal_check_mtk_cid},
	/*  ADD before this line */
...
unsigned int cam_cal_check_mtk_cid(struct i2c_client *client, cam_cal_cmd_func readCamCalData, unsigned int u4Offset, unsigned int  ui4_length)
{
	unsigned int calibrationID = 0, ret = 0;
	int j = 0;

	if (readCamCalData != NULL) {
		readCamCalData(client, u4Offset, (unsigned char *)&calibrationID, ui4_length);
...
unsigned int cam_cal_check_double_eeprom(struct i2c_client *client, cam_cal_cmd_func readCamCalData, unsigned int u4Offset, unsigned int  ui4_length)
{
	unsigned int calibrationID = 0, ret = 0;
