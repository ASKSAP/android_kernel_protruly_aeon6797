...
static imgsensor_info_struct imgsensor_info = {
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr, //SENSOR_OUTPUT_FORMAT_RAW_Gr,//SENSOR_OUTPUT_FORMAT_RAW_R,//sensor output first pixel color
...
#ifdef IMX258_DEVICE_SYNC
	if(powerOn){
		write_cmos_sensor(0x3004,0x01);
		write_cmos_sensor(0x5A5C,0x01);
		write_cmos_sensor(0x5A5D,0x01);
		write_cmos_sensor(0x4635,0x00);
		write_cmos_sensor(0x463b,0xff);
		write_cmos_sensor(0x5A5B,0X0F);
		write_cmos_sensor(0x5A90,0x04);
		write_cmos_sensor(0x5A92,0x04);
		write_cmos_sensor(0x5A93,0x40);
