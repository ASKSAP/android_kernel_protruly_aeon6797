 ...
 *    nick :R8866 driver full size  R3767 need modifyto R3767=0x1e
 *-------------------------------
 @DateTime:    20151104150659
 *    modify coding style to stabel in mt6797
 *	PengtaoFan
...
#include "ov8866mipiraw_Sensor.h"
...
#define PFX "OV8866"
#define LOG_1 SENSORDB("OV8866,MIPI CAM\n")
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	kal_uint16 OV8866_GAIN_BASE = 128;


	reg_gain = gain*OV8866_GAIN_BASE/BASEGAIN;
...
UINT32 OV8866_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	OV8866_MIPI_RAW_SensorInit	*/
