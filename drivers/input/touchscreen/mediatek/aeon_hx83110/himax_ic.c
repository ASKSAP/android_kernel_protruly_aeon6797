...
extern void himax_send_esd_event(void);
#endif
...
int himax_chip_self_test(struct i2c_client *client)
{
	...
	tmp_data[3] = 0x00; tmp_data[2] = 0xFF; tmp_data[1] = 0x0A; tmp_data[0] = 0xF0;
	tmp_data[7] = 0x00; tmp_data[6] = 0x00; tmp_data[5] = 0x0A; tmp_data[4] = 0xF0;
...
void himax_set_HSEN_enable(struct i2c_client *client, uint8_t HSEN_enable, bool suspended)
{
	...
	if(HSEN_enable)
	{
		tmp_addr[3] = 0x10; tmp_addr[2] = 0x00; tmp_addr[1] = 0x7F; tmp_addr[0] = 0x14;
...
void himax_interface_on(struct i2c_client *client)
{
	...
	if ( i2c_himax_write(client, 0x13 ,tmp_data, 1, HIMAX_I2C_RETRY_TIMES) < 0) {// to knock I2C
		E("%s: i2c access fail!\n", __func__);
		return;
	}
